...
Многие как и в прошлом примере используют map а не unordered_map, из-за чего, если много элементов, происходит частая балансировка, что может излишне сказаться на производительности. Если вам не надо содержать элементы отсортированными то предпочитайте unordered_map нежели map, учитывая количество элементов.
